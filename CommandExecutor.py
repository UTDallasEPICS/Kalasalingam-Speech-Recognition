...
class CommandExecutor:
    ...
    def playValidSound(self):
        playsound(r"C:\Users\arsh0\PycharmProjects\kalasalingam\ValidSoundEffect.mp3")

    def playInvalidSound(self):
        playsound(r"C:\Users\arsh0\PycharmProjects\kalasalingam\ErrorSoundEffect.mp3")
    ...
    def execute_command(self, command):
        try:
            ...
            if self.dictation_mode:
                ...
                if confidence > 70:  # You
                    # can adjust the confidence level as needed
                    self.low_confidence_count = 0
                    print(
                    ...
                    print(f"No confident command match found for '{command}'.")
